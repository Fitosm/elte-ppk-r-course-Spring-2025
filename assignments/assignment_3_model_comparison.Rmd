...
# Rule of thumb: cutoff = 4 / n
cutoff <- 4 / nrow(df)

# Identify influential points
influential_points <- which(cooks_d > cutoff)

length(influential_points)  # how many?
influential_points          # show their indices
...
plot(model_complex, which = 1)  # Residuals vs Fitted

#normality of residuals
plot(model_complex, which = 2)  # Q-Q Plot
